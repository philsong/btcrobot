...
func (w *Peatio) getOrderBook(symbol string) (ret bool, hbOrderBook OrderBook) {
...
func (w *Peatio) analyzeOrderBook2(body string) (ret bool, orderBook OrderBook) {
	//init to false
	ret = false
...
func (w *Peatio) analyzeOrderBook(body string) (ret bool, orderBook OrderBook) {
